...
PROMPT=" $POWERLINE_HOST_BG$POWERLINE_HOST_FG %m 
$POWERLINE_HOSTUSER_BG$POWERLINE_HOSTUSER_FG"$'\u25B6'"$POWERLINE_USER_BG$POWERLINE_USER_FG %n %k%f$POWERLINE_USERDIR_BG$POWERLINE_USERDIR_FG"$'\u25B6'"%k%f$POWERLINE_DIR_BG$POWERLINE_DIR_FG "$POWERLINE_CURRENT_PATH" "$POWERLINE_GIT_INFO_LEFT"%k%f$POWERLINE_END_BG$POWERLINE_END_FG"$'\u25B6'"%f "
