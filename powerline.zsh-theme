...
PROMPT="%k%f%F{white}%K{red} %m %K{green}%f%F{red}"$'\u25B6'"$POWERLINE_SEC1_BG$POWERLINE_SEC1_TXT %n %k%f$POWERLINE_SEC1_FG%K{blue}"$'\u25B6'"%k%f%F{white}%K{blue} "$POWERLINE_CURRENT_PATH" "$POWERLINE_GIT_INFO_LEFT"%k%f%F{blue}"$'\u25B6'"%f "
